                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="contact__form">
                                <sf:form class="form" action="/contact-sf-save" method="post" modelAttribute="contact" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-12">
                                            <div class="contact__form-input">
                                                <label for="uploadFile">Choose file to upload</label>
                                    				<input id="contactFile" name="contactFile" type="file" class="form-control-file" multiple="multiple" >
                                            </div>
                                        </div>
